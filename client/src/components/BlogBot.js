...
import "./BlogBot.css"; // Assuming you have some styles for the bot
      ...
      {showBot && (
        <>
          ...
          <iframe
            ...
            title="chatbot"
            src="https://cdn.botpress.cloud/webchat/v3.2/shareable.html?configUrl=https://files.bpcontent.cloud/2025/06/29/00/20250629004239-S7SCRKAZ.json"
            style={{
              position: "fixed",
              bottom: "0px",
              right: "0px",
